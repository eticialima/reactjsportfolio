            ...
            >
              ...
              >
                ...
                <Typography variant="body1" component="body1">
                  Um cenario de um jogo de terror muito forte. Um ambiente fechado com apenas uma cadeira misteriosa no centro da sala.
                  Texturas trabalhadas com sombra e janela modelada de frente com a lua. 
                </Typography>
                <br></br>
                <br></br>
      ...
      >
        <div className="footer-button">
          <div className="hero-btns">
            <a
              href="https://www.behance.net/gallery/91638733/chair-game-load"
              target="blank"
            >
              <Button
                className="btns"
